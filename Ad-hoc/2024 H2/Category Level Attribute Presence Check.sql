...
-- CREATE OR REPLACE TABLE sandbox.pj_mat_attr_check_comp_sales AS (
--     SELECT
--         category_id,
--         category_name,
...
-- CREATE OR REPLACE TABLE sandbox.pj_mat_attr_check_comp_ean AS (
--     SELECT
--         category_id,
--         category_name,
--         "Data Completeness" AS Data_Quality_Attribute,
...
-- CREATE OR REPLACE TABLE sandbox.pj_mat_attr_check_comp AS (
--     WITH joined AS (
--         SELECT * FROM sandbox.pj_mat_attr_check_comp_sales
--         UNION
--         SELECT * FROM sandbox.pj_mat_attr_check_comp_ean
--     )
...
-- CREATE OR REPLACE TABLE sandbox.pj_mat_attr_check_cons_sales AS (
--     SELECT
--         category_id,
--         category_name,
...
-- CREATE OR REPLACE TABLE sandbox.pj_mat_attr_check_cons_ean AS (
--     SELECT
--         category_id,
--         category_name,
--         "Data Consistency" AS Data_Quality_Attribute,
...
-- CREATE OR REPLACE TABLE sandbox.pj_mat_attr_check_cons AS (
--     WITH joined AS (
--         SELECT * FROM sandbox.pj_mat_attr_check_cons_sales
--         UNION
--         SELECT * FROM sandbox.pj_mat_attr_check_cons_ean
--     )
...
-- CREATE OR REPLACE TABLE sandbox.pj_mat_attr_check AS (
--     WITH joined AS (
--         SELECT * FROM sandbox.pj_mat_attr_check_comp
--         UNION
--         SELECT * FROM sandbox.pj_mat_attr_check_cons
--     )
...
SELECT *
FROM sandbox.pj_mat_attr_check
